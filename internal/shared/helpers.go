...
// GetTokenFromRequest extracts the Bearer token from the Authorization header or query param.
...
// BindAndValidate binds JSON to the payload struct and validates it.
...
// GetUserFromRequest extracts the authenticated user from the Gin context.
